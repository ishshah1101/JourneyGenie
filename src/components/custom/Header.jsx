...
function Header() {
  ...
  const headerStyle = isLandingPage
    ? "flex justify-between w-full p-5 px-5 text-center bg-transparent absolute top-0 left-0 z-10"
    : "flex justify-between w-full p-5 px-5 shadow text-center bg-blue-200";
            ...
            <Popover>
              ...
              <PopoverContent>
                ...
                <Link to="/trip-journal" style={{ color: "inherit" }}>
                  <Button
                    variant="ghost"
                    className="w-full text-left mt-2 text-current font-bold"
                  >
                    Trip Journal
                  </Button>
                </Link>
