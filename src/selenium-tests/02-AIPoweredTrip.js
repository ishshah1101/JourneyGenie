...
// Define the test suite
describe('Create Trip Generation Test', function() {
  let driver;
  ...
  it('trip should be created using AI', async function() {
    await driver.get('https://www.google.com');  // Open Google
    const title = await driver.getTitle();  // Get the title of the page
    console.log('Page Title: Create Trip');  // Log the page title for debugging
