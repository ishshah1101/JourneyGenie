...
describe('Flight Search Test', function() {
  ...
  it('should search the flight successfully between source and destination', async function() {
    await driver.get('https://www.google.com');  // Open Google
    const title = await driver.getTitle();  // Get the title of the page
    console.log('Page Title: Flight Search');  // Log the page title for debugging
