...
// Define the test suite
describe('Google Sign In Test', function() {
  let driver;
  ...
  it('user should be able to successfully sign in using gmail account', async function() {
    await driver.get('https://www.google.com');  // Open Google
    const title = await driver.getTitle();  // Get the title of the page
    console.log('Page Title: Gmail Sign In');  // Log the page title for debugging
